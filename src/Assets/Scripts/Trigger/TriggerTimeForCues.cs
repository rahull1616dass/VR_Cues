...
public class TriggerTimeForCues : MonoBehaviour
{
    ...
    public void StartByTimeTrigger(GameObject refCue, int TriggerTime, GameObject endTriggerObj = null)
    {
        cueToTrigger = refCue;
    ...
    public void EndByTimeTrigger(GameObject refCue, int TriggerTime)
    {
        cueToTrigger = refCue;
        RunTimeToTriggerCue(TriggerTime, false);
    }

    private async void RunTimeToTriggerCue(int triggerTimer, bool ObjectStateAfterTime)
    {
        await Task.Delay(triggerTimer);
    ...
    private void SaveLog(bool ObjectState, int triggerTimer)
    {
